...
public:
    ...
    // Selects the best (R, t) combination from E decomposition by checking cheirality and parallax.
    void SelectBestRtByCheiralityAndParallax(const Eigen::Matrix3f& R1, const Eigen::Matrix3f& R2, const Eigen::Vector3f& t,
